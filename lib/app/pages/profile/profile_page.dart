        ...
        odoo.searchRead("res.partner", [
          ...
          (OdooResponse res) {
            if (!res.hasError()) {
              setState(() {
                final result = res.getResult()['records'][0];
                bio = result['comment'] is! bool ? result['comment'] : "N/A";
                ...
                birth = result['birthdate_date'] is! bool
                    ? result['birthdate_date']
                    : "N/A";
                gender = result['gender'] is! bool ? result['gender'] : "N/A";
              });
            }
          },
        );
      ...
      child: Align(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              GestureDetector(
                onTap: () => Navigator.of(context).pushNamed("/profile_edit"),
                child: Container(
                  width: 150.0,
                  height: 150.0,
